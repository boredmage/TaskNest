...
const SignUp = () => {
  ...
  async function signUpWithEmail() {
    ...
    try {
      ...
      // The server returns a session straight away, so the root layout's
      // auth guard moves the user into the app as soon as this resolves.
      ...
      if (error instanceof ApiError && error.code === "user_already_exists") {
        ...
        showErrorToast("Error", errorMessage(error));
      }
