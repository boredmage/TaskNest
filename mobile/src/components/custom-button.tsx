...
const customButtonVariants = tv({
  base: "font-semibold rounded-xl text-base disabled:bg-transparent-day dark:disabled:bg-transparent-night disabled:opacity-100 disabled:text-red-500 group",
  variants: {
    intent: {
      primary: "bg-main",
