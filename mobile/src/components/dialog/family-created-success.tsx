      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="bg-background-day dark:bg-background-night gap-6">
          ...
          <View className="gap-1.5">
            <Dialog.Title className="text-text-day dark:text-text-night bg-transparent-day dark:bg-transparent-night rounded-xl p-2 text-center text-2xl font-semibold tracking-widest uppercase">
              {familyCode}
            </Dialog.Title>
