  ...
  return (
    <SafeAreaView style={{
      ...
      <View className="flex-1 px-4 gap-4">
        <Text className="text-2xl my-2 font-semibold text-text-day dark:text-text-night self-center">{t("tabs.tasks")}</Text>
        ...
        <View className='flex-1 items-center justify-center gap-2.5 pb-20'>
          <Text className='text-2xl font-semibold text-text-day dark:text-text-night'>No Tasks Yet</Text>
          <Text className='text-center max-w-72 text-hint text-base'>You don’t have any tasks right now. Create a new one to get started!</Text>
