import { View, Text, Pressable, Image, useColorScheme, ScrollView } from "react-native";
  ...
  const Row = ({
    ...
    const content = (
      <View className="flex-row items-center">
        ...
        <Text className="ml-4 text-base text-text-day dark:text-text-night flex-1">{title}</Text>
